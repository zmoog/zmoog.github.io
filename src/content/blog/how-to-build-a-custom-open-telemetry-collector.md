---
title: "How to build a custom OpenTelemetry Collector"
pubDatetime: 2024-12-24T08:49:38+01:00
tags:
  - open-telemetry
  - observability
  - golang
draft: false
description: "A step-by-step guide to building a custom OpenTelemetry Collector with custom receivers for solar panels and floor heating systems."
ogImage: "/images/how-to-build-a-custom-open-telemery-collector-anatomy.png"
---

OpenTelemetry has become a driving force in the observability space, but I only have limited opportunities to explore it during my working life.
...
According to [opentelemetry.io](https://opentelemetry.io/), Open Telemetry is:
...
I learned a lot about the OpenTelemetry Collector and how to build a custom collector. This custom Collector only includes the required components (receiver, processor, exporter, extension) and it's very compact.
